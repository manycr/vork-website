...
export function Header(){
 ...
 return <header className={`fixed inset-x-0 top-0 z-50 grid h-16 grid-cols-[auto_1fr_auto] items-center px-[7vw] transition-all duration-500 ${scrolled ? "h-14 bg-[#f4f0e8]/90 text-[#101010] shadow-[0_1px_0_rgba(0,0,0,0.06)] backdrop-blur-xl" : "bg-[#f1f1ef]/95 text-[#101010] border-b border-black/5 backdrop-blur-xl"}`}>
