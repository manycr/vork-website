...
export default async function StudioPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <Header />
      <section className="px-[7vw] pb-16 pt-32">
        ...
        <h1 className="max-w-5xl text-6xl font-black lowercase leading-[0.88] tracking-[-0.075em] md:text-8xl">proyectos y visualización.</h1>
      </section>
